package com.kelvin.catalogue.presentation.dashboard
...
import com.kelvin.catalogue.presentation.shared.component.ShimmerListItem
import com.kelvin.catalogue.presentation.shared.utils.OnLifecycleEvent
import com.kelvin.catalogue.presentation.theme.AppTheme
import com.kelvin.catalogue.presentation.dashboard.viewmodel.DashboardViewModel

private val buffer = 1

@Composable
fun DashboardScreen(viewModel: DashboardViewModel = hiltViewModel(), navController: NavHostController) {
